                                                    ...
                                                    <form action="{{ route('address.store') }}" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div style="display:flex">
                                                                ...
                                                                <button style="width:150px; margin-left:2rem" type="submit"
                                                                    class="common_btn ml-2">save
                                                                    address</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                        ...
                                        <div class="fp__checkout_single_address">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="home">
                                                    ...
                                                    @else
                                                        <span class="icon"><i class="fas fa-car-building"></i>
                                                            office</span>
                                                    @endif
            ...
            $('.v_address').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        grandTotal.text("{{ currencyPosition(':grandtotal') }}".replace(
