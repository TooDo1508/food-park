...
class PaymentController extends Controller
{
    ...
    public function makePayment(Request $request, OrderService $orderService)
    {
        ...
        try {
            // not have validate coupon null in order so coupon should be valid to process
    ...
    {
        $config = [
            'mode'    => config('gatewaySettings.paypal_acount_mode'), // Can only be 'sandbox' Or 'live'. If empty or invalid, 'live' will be used.
            'sandbox' => [
